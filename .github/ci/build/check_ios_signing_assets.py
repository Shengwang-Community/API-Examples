...
DISTRIBUTION_CERTIFICATE_ALIASES = (
    "apple distribution",
    "iphone distribution",
    "ios distribution",
)
...
def certificate_selector_matches(selector: str, identity_name: str) -> bool:
    ...
    if normalized_selector in normalized_identity:
        return True
    if normalized_selector in DISTRIBUTION_CERTIFICATE_ALIASES:
        return any(
            alias in normalized_identity
            for alias in DISTRIBUTION_CERTIFICATE_ALIASES
        )
    return False
    ...
    for profile_name in profile_names:
        ...
        for profile in candidates:
            matching_fingerprints = {
                ...
                and certificate_selector_matches(
