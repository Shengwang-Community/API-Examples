---
name: upsert-case
description: Add or modify an audio API example in the Android APIExample-Audio project, including source, layout, strings, navigation registration, architecture documentation, and voice-SDK constraints.
---
