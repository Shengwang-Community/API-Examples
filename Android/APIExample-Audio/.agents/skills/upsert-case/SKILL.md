...
6. `APIExample-Audio/.agent/skills/upsert-case/references/fragment-template.java`
...
3. Use `APIExample-Audio/.agent/skills/upsert-case/references/fragment-template.java` as the reference for engine lifecycle, usage reporting, private-cloud setup, and voice-only guardrails.
