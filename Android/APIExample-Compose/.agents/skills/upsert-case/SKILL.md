...
6. `APIExample-Compose/.agent/skills/upsert-case/references/composable-template.kt`
...
4. Use `APIExample-Compose/.agent/skills/upsert-case/references/composable-template.kt` for Compose state, lifecycle, permission, and registration patterns.
