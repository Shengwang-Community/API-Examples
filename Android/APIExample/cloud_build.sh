...
curl -L -H "X-JFrog-Art-Api:${JFROG_API_KEY}" -O "https://artifactory-api.bj2.agoralab.co/artifactory/qa_test_data/beauty/vender_agora_resources_apiexample.4.5.3.zip"
unzip -o vender_agora_resources_apiexample.4.5.3.zip
rm -f vender_agora_resources_apiexample.4.5.3.zip
cd - || exit 1
...
if [ "$WORKSPACE" != "" ]; then
    PROJECT_NAME="Shengwang-APIExample"
