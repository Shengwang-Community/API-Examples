# Shengwang RTC Native SDK 샘플 프로젝트

[English](README.md) | [中文](README.zh.md) | 한글

## 개요

이 Repository에는 다음 플랫폼들을 포함한 Shengwang RTC Native SDK의 샘플 프로젝트가 포함되어 있습니다:
...
| iOS      | Swift       | [iOS/APIExample-SwiftUI](iOS/APIExample-SwiftUI)         | [RTC Objective-C Video SDK](https://doc.shengwang.cn/doc/rtc/ios/resources)   |
...
- 제품 가이드와 API 레퍼런스는 [Shengwang 문서 센터](https://doc.shengwang.cn/)에서 확인할 수 있습니다.
- 더 많은 샘플은 [Shengwang Community](https://github.com/Shengwang-Community)에서 확인할 수 있습니다.
- 연동 관련 질문은 [개발자 커뮤니티](https://rtcdeveloper.com/)에 문의해 주세요.
