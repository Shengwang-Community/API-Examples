...
compile workflow also builds the complete Android Audio/Compose and four iOS templates in
their real application targets. Structural validation alone does not establish template API
correctness or safe asynchronous cleanup.
