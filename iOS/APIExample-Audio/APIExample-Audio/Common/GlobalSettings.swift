...
class GlobalSettings {
    ...
    // For the regions that Agora supports, see https://doc.shengwang.cn/api-ref/rtc/ios/API/enum_areacode. After specifying the region, the SDK connects to the Agora servers within that region.
