...
|------|-------|-------------|
| Add or modify a case | `.agents/skills/upsert-case/` | Need to create a new API demo or update an existing one |
| Code review | `.agents/skills/review-case/` | Review case code for lifecycle, thread safety, and convention compliance |
