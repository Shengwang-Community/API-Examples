...
Use a nearby case with the same media path as the implementation reference, then adapt it
to the new behavior contract and current SDK APIs.
...
- **SDK documentation:** Refer to Shengwang RTC SDK for macOS documentation for API details
