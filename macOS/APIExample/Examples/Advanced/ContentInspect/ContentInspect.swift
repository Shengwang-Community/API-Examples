...
///
/// More detail: https://doc.shengwang.cn/doc/rtc/macos/advanced-features/content-inspect
...
extension ContentInspectViewController: AgoraRtcEngineDelegate {
    ...
    func rtcEngine(_ engine: AgoraRtcEngineKit, didOccurError errorCode: AgoraErrorCode) {
        /// Error code description: https://doc.shengwang.cn/api-ref/rtc/macos/error-code
