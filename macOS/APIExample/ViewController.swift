...
class MenuController: NSViewController {
    ...
    var menus:[MenuItem] = [
        ...
        MenuItem(name: "Advanced", identifier: "headerCell"),
        ...
        MenuItem(name: "Voice Effects".localized, identifier: "menuCell", controller: "VoiceChanger", storyboard: "VoiceChanger"),
        MenuItem(name: "Custom Audio Source (PCM)".localized, identifier: "menuCell", controller: "CustomAudioSource", storyboard: "CustomAudioSource"),
...
//        MenuItem(name: "Raw Media Data".localized, identifier: "menuCell", controller: "RawMediaData", storyboard: "RawMediaData"),
        ...
        MenuItem(name: "Custom Video Source".localized, identifier: "menuCell", controller: "CustomVideoSourcePush", storyboard: "CustomVideoSourcePush"),
        MenuItem(name: "Multiple Video Sources".localized, identifier: "menuCell", controller: "CustomVideoSourcePushMulti", storyboard: "CustomVideoSourcePushMulti"),
        ...
        MenuItem(name: "Simple Filter Extension".localized, identifier: "menuCell", controller: "SimpleFilter", storyboard: "SimpleFilter"),
        MenuItem(name: "Video Process".localized, identifier: "menuCell", controller: "Video Process", storyboard: "VideoProcess"),
        MenuItem(name: "Local Video Transcoding".localized, identifier: "menuCell", controller: "LocalVideoTranscoding", storyboard: "LocalVideoTranscoding"),
        ...
        MenuItem(name: "Pre-call Test".localized, identifier: "menuCell", controller: "PrecallTest", storyboard: "PrecallTest"),
        ...
        MenuItem(name: "Send Data Stream".localized, identifier: "menuCell", controller: "CreateDataStream", storyboard: "CreateDataStream"),
        ...
        MenuItem(name: "Multi Camera".localized, identifier: "menuCell", controller: "MultiCameraSourece", storyboard: "MultiCameraSourece"),
        MenuItem(name: "Beauty 2.0".localized, identifier: "menuCell", controller: "AgoraBeauty", storyboard: "AgoraBeauty"),
